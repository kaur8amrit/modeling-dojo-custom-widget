define([
    ...
    "dojo/text!InfoButton/widget/template/InfoButton.html"
    ...
    return declare("InfoButton.widget.InfoButton", [_WidgetBase, _TemplatedMixin], {
...
require(["InfoButton/widget/InfoButton"]);
